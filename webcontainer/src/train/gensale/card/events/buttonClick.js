...
export function buttonClick(props, id, hotkey, isFromSide) {
    switch (id) {
        ...
        case CARD_BUTTON.delete:
            promptBox({
                color: 'warning',
                title: props.json['TR101010-000000'],/* 国际化处理： 删除*/
                content: props.json['TR101010-000001'],/* 国际化处理： 确定删除吗？*/
                beSureBtnClick: () => {
                    cardDelete(props);
                }
            });
        ...
        case CARD_BUTTON.cancel:
            promptBox({
                color: 'warning',
                title: props.json['TR101010-000002'],/* 国际化处理： 取消*/
                content: props.json['TR101010-000003'],/* 国际化处理： 是否确认要取消?*/
                beSureBtnClick: () => {
                    cardCancel(props);
                }
            });
