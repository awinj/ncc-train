...
(function () {
    ...
    Music.prototype = {
        total:70,
        pageSize:10,
        dataUrl:"/v1/restserver/ting?method=baidu.ting.search.common",
        playerUrl:"/widget/flash/bdspacesong.swf",
        ...
        _buildMusicHtml:function (playerUrl) {
            var html = '<embed class="BDE_try_Music" allowfullscreen="false" pluginspage="/go/getflashplayer"';
            html += ' src="' + playerUrl + '"';
