 ...
 * @link   /rgb-color-parser-in-javascript/
	...
	function build() {
		...
		svg.BoundingBox = function(x1, y1, x2, y2) { // pass in initial points if you want
			...
			this.addBezierCurve = function(p0x, p0y, p1x, p1y, p2x, p2y, p3x, p3y) {
				// from 2009/06/how-to-calculate-bezier-curves-bounding.html
		...
		svg.AspectRatio = function(ctx, aspectRatio, width, desiredWidth, height, desiredHeight, minX, minY, refX, refY) {
			// aspect ratio - /TR/SVG/coords.html#PreserveAspectRatioAttribute
		...
		svg.Element.path = function(node) {
			...
			// TODO: convert to real lexer based on /TR/SVG11/paths.html#PathDataBNF
...
(function (Highcharts) { // encapsulate
	...
	extend(CanVGRenderer.prototype, {
		 ...
		 * see: p/canvg/issues/detail?id=104
		 *
