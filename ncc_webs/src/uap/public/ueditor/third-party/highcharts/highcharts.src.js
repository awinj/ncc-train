...
function numberFormat(number, decimals, decPoint, thousandsSep) {
	var lang = defaultOptions.lang,
		// /techblog/article/javascript_equivalent_for_phps_number_format/
		n = +number || 0,
		c = decimals === -1 ?
...
/**
 * Based on /manual/en/function.strftime.php
 * @param {String} format
...
(function ($) {
	...
	win.HighchartsAdapter = win.HighchartsAdapter || ($ && {
		...
		removeEvent: function (el, eventType, handler) {
			...
			// /topic/javascript-error-when-unbinding-a-custom-event-using-jQuery-1-4-2
...
defaultOptions = {
	...
	global: {
		useUTC: true,
		canvasToolsURL: '/3.0.6/modules/canvas-tools.js',
		VMLRadialGradientURL: '/3.0.6/gfx/vml-radial-gradient.png'
	},
	chart: {
		//animation: true,
		//alignTicks: false,
...
SVGRenderer.prototype = {
	...
	fontMetrics: function (fontSize) {
		...
		// Applies to the default font family. /highcharts/7xvn7/
...
Highcharts.VMLElement = VMLElement = {
	...
	setSpanRotation: function (rotation, sintheta, costheta) {
		...
		// Test case: /tests/?file=text-rotation
		css(this.element, {
