...
/**
 * @fileOverview 让内部各个部件的代码可以用[amd](httpsamdjs/amdjs-api/wiki/AMD)模块定义方式组织起来。
 *
...
(function( root, factory ) {
    var modules = {},
        ...
        // 内部require, 简单不完全实现。
        // httpsamdjs/amdjs-api/wiki/require
     ...
     *
     * As you know, Web Uploader的每个文件都是用过[AMD](httpsamdjs/amdjs-api/wiki/AMD)规范中的`define`组织起来的, 每个Module都会有个module id.
    ...
    define('base',[
        ...
        return {
            ...
            /**
             * 被[uncurrythis](/2011/11/uncurrying-this.html)的数组slice方法。
             * 将用来将非数组对象转化成数组对象。
    ...
    define('file',[
        ...
        function WUFile( source ) {
            ...
            /**
             * 文件MIMETYPE类型，与文件类型的对应关系请参考[/z8ZnFny](/z8ZnFny)
             * @property type
             * @type {string}
             * @default 'application'
             */
    ...
    /**
     * 代码来自于：httpsblueimp/JavaScript-Load-Image
     * 暂时项目中只用了orientation.
     *
    ...
    define('runtime/html5/image',[
        ...
        return Html5Runtime.register( 'Image', {
            ...
            // httpsstomita/ios-imagefile-megapixel/
        ...
        return Html5Runtime.register( 'Transport', {
            ...
            send: function() {
                ...
                if ( binary ) {
                    ...
                    // bug详情。
                    // httpsp/android/issues/detail?id=39882
